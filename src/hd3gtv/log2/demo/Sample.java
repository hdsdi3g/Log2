...
public class Sample {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*
			RETURN
			2011/12/05 15:36:31,095 INFO Sample "Start sample thread 1" main,1
			 at hd3gtv.log2.demo.Sample.main(Sample.java:55)
			info Nothing to tell

			2011/12/05 15:36:31,096 INFO Sample "Start sample thread 2" main,1
			 at hd3gtv.log2.demo.Sample.main(Sample.java:57)
			info Nothing to tell

			2011/12/05 15:36:31,096 INFO SampleThread "I run from a thread !" Thread-1,10
			 at hd3gtv.log2.demo.SampleThread.run(SampleThread.java:14)
			2011/12/05 15:36:31,096 INFO SampleThread "I run from a thread !" Thread-2,11
			 at hd3gtv.log2.demo.SampleThread.run(SampleThread.java:14)
			2011/12/05 15:36:31,097 INFO Sample "Done" main,1
			 at hd3gtv.log2.demo.Sample.main(Sample.java:59)
